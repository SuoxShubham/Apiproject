// 856cce414765063c84fd89da48d3c246
class ZOMATO{
    constructor(){
        this.api="45a627e50af7341708f58186dce2b695";
        this.header={
            method:'GET',
            headers:{
                "user-key":this.api,
    ...
    async searchAPI(city,categoryID){
        ...
        const cityURL=`https://developers.zomato.com/api/v2.1/cities?q=Bangalore`;
 ...
 const restaurantURL=`https://developers.zomato.com/api/v2.1/search?entity_id=${cityID}&entity_type=city&category=${categoryID}&sort=real_distance;`
...
class UI{
    ...
    getRestaurants(restaurants){
        ...
        if(restaurants.length === 0){
            this.showFeedback("no such category exist in this city");
        } else {
